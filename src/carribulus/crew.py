...
class Carribulus():
    ...
    self.agents.append(self.create_reporting_analyst())
    self.tasks = []
    self.tasks.append(self.create_research_task())
    self.tasks.append(self.create_reporting_task())
    """
